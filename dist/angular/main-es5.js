...
var AddCategoryComponent = /** @class */ (function () {
    function AddCategoryComponent(_productcatalogService) {
    ...
    AddCategoryComponent.prototype.onSubmit = function (add) {
        var _this = this;
        this._productcatalogService.createCategory(add.value).subscribe(function (data) {
            _this.categories = new _category_category_model__WEBPACK_IMPORTED_MODULE_2__["Category"]();
...
var CategoryListComponent = /** @class */ (function () {
    function CategoryListComponent(productCatalog) {
...
var EditCategoryComponent = /** @class */ (function () {
    function EditCategoryComponent(_productcatalogService, router, formBuilder) {
        this._productcatalogService = _productcatalogService;
        this.router = router;
...
var ProductCatalogService = /** @class */ (function () {
    ...
    // }
    //gets all categories
    ProductCatalogService.prototype.getAllCategories = function () {
        return this.http.get("https://sheltered-falls-45349.herokuapp.com/api/category");
    };
    ProductCatalogService.prototype.createCategory = function (category) {
        return this.http.post(this._Url, category);
    };
    //Edit a category
    ProductCatalogService.prototype.updateCategory = function (categoryid, category) {
        var _Url = 'https://sheltered-falls-45349.herokuapp.com/api/category/' + "/" + categoryid;
        return this.http.put(_Url, category).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return console.log("updated category categoryid=" + categoryid); }));
    };
    //delete a category
    ProductCatalogService.prototype.deleteCategory = function (categoryid) {
        return this.http.delete('https://sheltered-falls-45349.herokuapp.com/api/category/' + categoryid);
    };
    ProductCatalogService.ctorParameters = function () { return [
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.createProduct = function (product, categoryid) {
...
var ProductComponent = /** @class */ (function () {
    ...
    ProductComponent.prototype.ngOnInit = function () {
        ...
        var _this = this;
        this.product.getAllproducts().subscribe(function (data) {
            _this.products = data;
    ...
    ProductComponent.prototype.delete = function (id) {
        var _this = this;
        this.product.deleteProduct(id).subscribe(function (data) {
            _this.products = data;
            console.log(_this.products);
        });
    };
